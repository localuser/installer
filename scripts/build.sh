...
docker build --no-cache -t staff-api-server .
...
docker build --no-cache -t staff-app-admin .
...
docker build --no-cache -t staff-app-web .
...
docker build --no-cache -t staff-app-desktop .
